...
if(isset($_POST['submit']))
{
    ...
    else
    {
        ...
        if(preg_match("/^([a-zA-Z0-9])+([a-zA-Z0-9._-])*@([a-zA-Z0-9_-])+([a-zA-Z0-9._-]+)+$/", $_POST['email']))
        {
            ...
            $result1 = mysqli_query($mysqli,$sql1) or die(mysql_error());
    ...
    else
    {
        ...
        $result2 = mysqli_query($mysqli,$sql2) or die(mysql_error());
        ...
        if($result2)
        {
            ...
            $message .= "http://www.yourname.com/validate.php?passkey=$com_code";
